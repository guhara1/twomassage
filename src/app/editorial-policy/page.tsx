    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="mt-5 max-w-3xl leading-8 text-muted-foreground">본 사이트의 콘텐츠는 출장마사지 웰니스 서비스 이용자가 안전하고 합리적인 선택을 할 수 있도록 돕기 위해 작성됩니다. 검색 순위 조작을 목적으로 대량 생성된 콘텐츠를 게시하지 않습니다.</p>
          ...
          <div className="mt-10"><ContentBlocks blocks={policyBlocks.editorial} /></div>
        </div>
      </section>
    </>
  );
