      ...
      <section className="section">
        <div className="container">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            ...
            <Card><h2 className="text-xl font-bold">포함 사항</h2><p className="mt-3 text-sm leading-7 text-muted-foreground">테라피스트 방문, 기본 위생 준비, 서비스 전 컨디션 확인, 서비스 후 간단 피드백이 포함됩니다.</p></Card>
